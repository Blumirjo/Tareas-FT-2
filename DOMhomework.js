...
// Tu código acá:
document.querySelector('#createdBy').innerHTML = 'Aplicación creada por Sebastian Gatica';
...
function buildToDos(toDos) {
  // Tu código acá:
   var nuevoArray = toDos.map(function(e,i){
...
//  3) Setear el valor del input toDoInput como un string vacio ("") (Esto se realiza para que 
//en la vista se borre lo que se encontraba escrito)
//  4) Llamar a la función displayToDos para que se actualicen los toDos mostrados en pantalla

function addToDo() {
  // Tu código acá:
 var todo = new ToDo(document.getElementById('toDoInput').value)
 toDoItems.push(todo);
